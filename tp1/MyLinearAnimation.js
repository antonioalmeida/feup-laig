function MyLinearAnimation(id, velocity, controlPoints) {
    ...
    for(let i = 0; i < controlPoints.length; ++i){
        this.controlPoints.push(vec3.fromValues(controlPoints[i][0], controlPoints[i][1], controlPoints[i][2])); //If does not work use controlPoints[0], controlPoints[1], controlPoints[2]
        if(i > 0){
